...
#inputs
data_dir="/userdirs/aloka/p4_parallel_data_curation/data/ccmatrix_sentSim_6gram/csv_files"
input_file = "en-si-labse-sorted-src-sentSim_6gram.train.csv"
...
src_lang="en"
tgt_lang="si"
output_dir="/userdirs/aloka/p4_parallel_data_curation/data/ccmatrix_{}/".format(exp_file_name)
...
def return_sentSim_indexes(row, preprocessed_df_copy):
    ...
    return list(set(preprocessed_df_copy[preprocessed_df_copy["has_overlapping_indexes"] == True].index.tolist())-{row.name})
